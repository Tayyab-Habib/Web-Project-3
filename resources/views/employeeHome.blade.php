...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
         @section('content')
         <h1 class="p-heading" style="color:white;">Employee Pannel</h1>
         <button class="btn" onclick="location.href='/bye'">Logout</button>
            <div class="container">
                <div class="box">
                    <h1 class="color" class="head">Guests Details</h1>
                    <ul>
                        <?php 
                            print "<li>No of guests = " .$guestsCount. "</li>";
                            print "<li>Total Number of Guest = " .$guestsCount. "</li>";
                        ?>
            ...
            <div class="info">
                <h1 style="text-align:center; color:white;">Personal Information</h1>
                <div class="data">
                    <div class="head">
                    ...
                    <div class="table">
                        ...
                        <?php 
                            ...
                            print "</tr>";
                            print "<tr>";
                                print "<td> <strong>Phone No: </strong> </td>";
